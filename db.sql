CREATE SCHEMA IF NOT EXISTS `db_gzxkyy` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `db_gzxkyy` ;

-- -----------------------------------------------------
-- Table `db_gzxkyy`.`cns_man`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_gzxkyy`.`cns_manager` (
...
-- -----------------------------------------------------
-- Table `db_gzxkyy`.`cns_category`
-- -----------------------------------------------------

CREATE TABLE IF NOT EXISTS `db_gzxkyy`.`cns_category` (
...
-- -----------------------------------------------------
-- Table `db_gzxkyy`.`cns_news`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_gzxkyy`.`cns_news` (
  `id` INT(11)  NOT NULL AUTO_INCREMENT COMMENT '主键，自增',
...
-- -----------------------------------------------------
-- Table `db_gzxkyy`.`cns_article`
-- -----------------------------------------------------

CREATE TABLE IF NOT EXISTS `db_gzxkyy`.`cns_article` (
  `id` INT(11)  NOT NULL AUTO_INCREMENT COMMENT '主键，自增',
  `title` VARCHAR(255) NOT NULL DEFAULT '' COMMENT '标题',
  `sort` INT(11) NOT NULL DEFAULT 0 COMMENT '排序',
  `cate_id` TINYINT(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '类别id',
...
-- -----------------------------------------------------
-- Table `db_gzxkyy`.`cns_city`
-- -----------------------------------------------------

CREATE TABLE IF NOT EXISTS `db_gzxkyy`.`cns_city` (
  `id` INT(11)  NOT NULL AUTO_INCREMENT COMMENT '主键，自增',
...
-- -----------------------------------------------------
-- Table `db_gzxkyy`.`cns_theater`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_gzxkyy`.`cns_theater` (
  `id` INT(11)  NOT NULL AUTO_INCREMENT COMMENT '主键，自增',
...
-- -----------------------------------------------------
-- Table `db_gzxkyy`.`cns_theater_pic`
-- -----------------------------------------------------

CREATE TABLE IF NOT EXISTS `db_gzxkyy`.`cns_theater_photo` (
  `id` INT(11)  NOT NULL AUTO_INCREMENT COMMENT '主键，自增',
...
-- -----------------------------------------------------
-- Table `db_gzxkyy`.`cns_movie`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_gzxkyy`.`cns_movie` (
  `id` INT(11)  NOT NULL AUTO_INCREMENT COMMENT '主键，自增',
...
-- -----------------------------------------------------
-- Table `db_gzxkyy`.`cns_comment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_gzxkyy`.`cns_comment` (
  `id` INT(11)  NOT NULL AUTO_INCREMENT COMMENT '主键，自增',
...
-- -----------------------------------------------------
-- Table `db_gzxkyy`.`cns_enterprise`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_gzxkyy`.`cns_enterprise` (
  `id` INT(11)  NOT NULL AUTO_INCREMENT COMMENT '主键，自增',
  `name` VARCHAR(255) NOT NULL DEFAULT '' COMMENT '名称',
...
-- -----------------------------------------------------
-- Table `db_gzxkyy`.`cns_ad`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_gzxkyy`.`cns_ad` (
  `id` INT(11)  NOT NULL AUTO_INCREMENT COMMENT '主键，自增',
...
-- -----------------------------------------------------
-- Table `db_gzxkyy`.`cns_kanwu`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_gzxkyy`.`cns_kanwu` (
  `id` INT(11)  NOT NULL AUTO_INCREMENT COMMENT '主键，自增',
  `title` VARCHAR(255) NOT NULL DEFAULT '' COMMENT '标题',
