                          ...
                          <form class="form-horizontal bordered-group" role="form" action="<?php echo U('Article/editHandle');?>" method="post">
                              ...
                              <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-8">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="hot" value="1" <?php if($data['hot']): ?>checked<?php endif; ?>>热点点文章
                                        </label>
                                    </div>
                                </div>
                              </div>
                              ...
                              <input type="hidden" name="face368" value="<?php echo ($data["face368"]); ?>">
                              <input type="hidden" name="face208" value="<?php echo ($data["face208"]); ?>">
                              <input type="hidden" name="face258" value="<?php echo ($data["face258"]); ?>">
                              <input type="hidden" name="face255" value="<?php echo ($data["face255"]); ?>">
  ...
  setTimeout(function() {
     var sid = "<?php echo session_id();?>";
        $('#upload').uploadify({
          ...
          'uploader'      :    "<?php echo U('Base/uploadArticleFace');?>",
