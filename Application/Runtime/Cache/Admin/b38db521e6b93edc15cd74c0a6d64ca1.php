                                        ...
                                        <table id="table" class="table table-striped responsive" data-sortable="" data-sortable-initialized="true">
                                            ...
                                            <tbody>
                                            	<?php if(is_array($comment)): foreach($comment as $key=>$v): ?><tr>
                                                        <td><?php echo ($v["id"]); ?></td>
	                                                    <td><?php echo (date("Y-m-d H:i", $v["comment_time"])); ?></td>
	                                                    <td><?php echo (htmlspecialchars_decode($v["content"])); ?></td>
	                                                    <td>
                                             			  	<a class="del" href="<?php echo U('Movie/delComment', ['id' => $v['id']]);?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="删除"><span class="fa fa-trash-o text-success"></span></a>
	                                                    </td>
