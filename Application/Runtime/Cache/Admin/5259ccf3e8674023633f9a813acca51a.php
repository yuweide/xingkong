                	...
                	<div class="col-lg-12">
                 	<section class="panel">
                      ...
                      <div class="panel-body">
                          <form class="form-horizontal bordered-group" role="form" action="<?php echo U('Movie/editHandle');?>" method="post">
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" name="name" value="<?php echo ($data["name"]); ?>" placeholder="电影名称" class="form-control" id="inputEmail3">
                                  </div>
                              </div>
                              ...
                              <div class="form-group">
	                              <div class="col-sm-offset-2 col-sm-8">
	                                  <div class="checkbox">
	                                      <label>
	                                          <input type="checkbox" name="recommend" value="<?php echo ($data["recommend"]); ?>" <?php if($data['recommend'] == 1): ?>echeked<?php endif; ?>>推荐
	                                      </label>
	                                  </div>
	                              </div>
                              </div>
                              ...
                              <input type="hidden" name="face209" value="<?php echo ($data["face209"]); ?>">
                              <input type="hidden" name="face196" value="<?php echo ($data["face196"]); ?>">
                              <input type="hidden" name="face142" value="<?php echo ($data["face142"]); ?>">
                              <input type="hidden" name="face96" value="<?php echo ($data["face96"]); ?>">
