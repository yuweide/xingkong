                    	...
                    	<div class="col-lg-12">
                    		<section>
                                <ul id="myTab2" class="nav nav-tabs">
                                    <li class="">
                                        <a href="#home" data-toggle="tab">影视类别</a>
                                    </li>
                                    <li class="active">
                                                ...
                                                <section class="panel">
												    <div class="panel-body  no-padding">
												        <table class="table table-bordered table-hover no-margin">
												            ...
												            <tbody>
												            	<?php if(is_array($videoLists)): foreach($videoLists as $key=>$v): ?><tr>
												                        <td><?php echo ($v["id"]); ?></td>
												                        ...
												                        <td>
												                        	<a href="<?php echo U('Category/edit', array('id' => $v['id']));?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="编辑"><i class="fa fa-edit"></i></a>
												                        	<a href="<?php echo U('Category/nonUse', array('id' => $v['id']));?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="停用"><i class="fa fa-trash-o"></i></a>
												                        </td>
												    ...
												    <div class="panel-footer no-border no-padding">
												    	<div style="margin-top:10px;">
												            	<a class="btn btn-color btn-sm" href="<?php echo U('Category/add', array('type' => 2));?>"><i class="fa fa-plus"></i> 添加</a>
												    	</div>
												    </div>
												</section>
                                            </div>
                                                 ...
                                                 <section class="panel">
												    <div class="panel-body  no-padding">
												        <table class="table table-bordered table-hover no-margin">
												            ...
												            <tbody>
												            	<?php if(is_array($newsLists)): foreach($newsLists as $key=>$v): ?><tr>
												                        <td><?php echo ($v["id"]); ?></td>
												                        <td><?php echo ($v["name"]); ?></td>
												                        <td><?php echo ($v["remark"]); ?></td>
												                        <td><?php echo ($v["sort"]); ?></td>
												    ...
												    <div class="panel-footer no-border no-padding">
												    	<div style="margin-top:10px;">
											            	<a class="btn btn-color btn-sm" href="<?php echo U('Category/add', array('type' => 1));?>"><i class="fa fa-plus"></i> 添加</a>
												    	</div>
												    </div>
												</section>
                                            </div>
                                                 ...
                                                 <section class="panel">
												    <div class="panel-body  no-padding">
												        <table class="table table-bordered table-hover no-margin">
												            ...
												            <tbody>
												            	<?php if(is_array($kanwuLists)): foreach($kanwuLists as $key=>$v): ?><tr>
												                        <td><?php echo ($v["id"]); ?></td>
												                        <td><?php echo ($v["name"]); ?></td>
												                        <td><?php echo ($v["remark"]); ?></td>
												                        <td><?php echo ($v["sort"]); ?></td>
												    ...
												    <div class="panel-footer no-border no-padding">
												    	<div style="margin-top:10px;">
												            	<a class="btn btn-color btn-sm" href="<?php echo U('Category/add', array('type' => 3));?>"><i class="fa fa-plus"></i> 添加</a>
												    	</div>
												    </div>
												</section>
                                            </div>
