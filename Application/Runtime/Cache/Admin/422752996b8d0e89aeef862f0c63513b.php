                	...
                	<div class="col-lg-12">
                 	<section class="panel">
                      ...
                      <div class="panel-body">
                          <form class="form-horizontal bordered-group" role="form" action="<?php echo U('Theater/addHandle');?>" method="post">
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" name="name" placeholder="影城名称" class="form-control" id="inputEmail3">
                                  </div>
                              </div>
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" class="form-control" value="" name="address" id="inputEmail6" placeholder="地址">
                                  </div>
                              </div>
                              <div class="form-group">
                                  <label for="inputEmail5" class="col-sm-2 control-label">经度</label>
                                  <div class="col-sm-8">
                                      <input type="text" class="form-control" name="x" id="inputEmail5" placeholder="用于地图定位">
                                  </div>
                              </div>
                              <div class="form-group">
                                  <label for="inputEmail5" class="col-sm-2 control-label">维度</label>
                                  <div class="col-sm-8">
                                      <input type="text" class="form-control" name="y" id="inputEmail5" placeholder="用于地图定位">
                                  </div>
                              </div>
                              <div class="form-group">
                                  <label for="inputEmail5" class="col-sm-2 control-label">订票热线</label>
                                  <div class="col-sm-8">
                                      <input type="text" class="form-control" name="order_line" id="inputEmail5" placeholder="订票热线">
                                  </div>
                              </div>
                               <div class="form-group">
                                  <label for="inputEmail5" class="col-sm-2 control-label">团购热线</label>
                                  <div class="col-sm-8">
                                      <input type="text" class="form-control" name="group_line" id="inputEmail5" placeholder="团购热线">
                                  </div>
                              </div>
                              <div class="form-group">
                              ...
                              <input type="hidden" name="face520">
