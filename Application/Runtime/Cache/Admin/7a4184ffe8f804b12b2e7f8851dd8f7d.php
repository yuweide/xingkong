	                                        ...
	                                        <div class="panel-body">
	                                            <div class="switcher-content">
	                                                ...
	                                                <ul class="text-muted list-style-none" style="font-size:14px;">
	                                                	...
	                                                	<a class="del" href="<?php echo U('Article/del', ['id' => $v['id']]);?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="删除"><span class="fa fa-trash-o text-success"></span></a>
	                                                </ul>
