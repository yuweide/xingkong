                	...
                	<div class="col-lg-12">
                 	<section class="panel">
                      ...
                      <div class="panel-body">
                          <form class="form-horizontal bordered-group" role="form" action="<?php echo U('Enterprise/editHandle');?>" method="post">
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-2">
                                  	<img id="no-image" height="230" width="200" <?php if($data['face245']): ?>src="/xingkong/<?php echo ($data["face245"]); ?>"<?php else: ?> src="/xingkong/Public/Default/images/no_image.jpg"<?php endif; ?>>
                                  </div>
                              ...
                              <input type="hidden" name="face245" value="<?php echo ($data["face245"]); ?>">
	...
	setTimeout(function() {
		 var sid = "<?php echo session_id();?>";
		    $('#upload').uploadify({
		      ...
		      'uploader'      :    "<?php echo U('Base/uploadEnterpriseFace');?>",
		      ...
		      onUploadSuccess :     function(file, data, response) {
		        ...
		        if (data.status == 1) {
		        	...
		        	$('#no-image').attr('src', "/xingkong/"+data.path.face245);
		        } else {
		         	alert('图片上传失败，请重试...');
		        }
		      }
