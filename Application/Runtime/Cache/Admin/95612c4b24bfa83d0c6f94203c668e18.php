                    	...
                    	<div class="col-lg-12">
	                    	...
	                    	<section class="panel">
		                        ...
		                        <div class="panel-body">
		                            <form class="form-horizontal bordered-group" role="form" action="<?php echo U('Category/addHandle');?>" method="post">
		                                <div class="form-group">
		                                ...
		                                <div class="form-group">
		                                    ...
		                                    <div class="col-sm-6">
		                                        <input type="text" class="form-control" name="sort" id="inputEmail3" value="0" placeholder="排序">
		                                    </div>
		                                </div>
