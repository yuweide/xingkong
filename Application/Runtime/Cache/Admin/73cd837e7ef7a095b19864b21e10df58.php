                	...
                	<div class="col-lg-12">
                 	<section class="panel">
                      ...
                      <div class="panel-body">
                          <form class="form-horizontal bordered-group" role="form" action="<?php echo U('Movie/addHandle');?>" method="post">
	                              <div class="form-group">
	                                 <div class="form-group">
	                                  ...
	                                  <div class="col-sm-8">
	                                      ...
	                                      <p class="help-block no-margin">格式：flv</p>
	                                  </div>
                            	  </div>
  ...
  $(function() {
		...
		setTimeout(function() {
			    $('#upload').uploadify({
			      ...
			      'uploader'      :    "<?php echo U('Base/uploadMovieFace');?>",
		...
		setTimeout(function() {
		    $('#upload-movie').uploadify({
		      'swf'           :    "/xingkong/Public/Plugin/uploadify/uploadify.swf",
		      'uploader'      :    "<?php echo U('Base/uploadMovie');?>",
		      'buttonImage'   :    "/xingkong/Public/Plugin/uploadify/browse-btn-file.png",
		      'width'         :    "120",
		      'height'        :    "30",
		      'fileTypeDesc'  :    "Image file",
		      'fileTypeExts'  :    "*.flv",
