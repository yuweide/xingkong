                	...
                	<div class="col-lg-12">
                 	<section class="panel">
                      ...
                      <div class="panel-body">
                          <form class="form-horizontal bordered-group" role="form" action="<?php echo U('Kanwu/addHandle');?>" method="post">
	                              <div class="form-group">
	                                 <div class="form-group">
  ...
  $(function() {
		...
		setTimeout(function() {
			    $('#upload').uploadify({
			      ...
			      'uploader'      :    "<?php echo U('Base/uploadKanwuFace');?>",
			      ...
			      onUploadSuccess :     function(file, data, response) {
			        ...
			        if (data.status == 1) {
			        	...
			        	$('#no-image').attr('src', "/xingkong/"+data.path.face240);
			        } else {
			        	alert('图片上传失败，请重试');
			        }
			      }
		...
		setTimeout(function() {
		    $('#upload-movie').uploadify({
		      'swf'           :    "/xingkong/Public/Plugin/uploadify/uploadify.swf",
		      'uploader'      :    "<?php echo U('Base/uploadPdf');?>",
