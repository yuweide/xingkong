                      ...
                      <div class="panel-body">
                          <form class="form-horizontal bordered-group" role="form" action="<?php echo U('Article/addHandle');?>" method="post">
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-2">
                                  	<img id="no-image" height="230" width="200" src="/xingkong/Public/Default/images/no_image.jpg" >
                                  </div>
                                  <div class="col-sm-8" style="margin-top:20px;">
                                      <input type="file" name="face" id="upload" />
                                      <p class="help-block no-margin">格式：jpg、jpeg、gif、png</p>
                                  </div>
                              </div>
                              ...
                              <input type="hidden" name="face368">
                              <input type="hidden" name="face208">
                              <input type="hidden" name="face258">
                              <input type="hidden" name="face255">
