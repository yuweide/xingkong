                        ...
                        <div class="col-xs-12">
                            <section class="panel">
                                <header class="panel-heading">
                                	...
                                	<?php echo ($titleL1); ?>&nbsp;&nbsp;
                                	<a class="btn btn-success btn-xs" href="<?php echo U('Enterprise/add');?>">添加企业</a>
                                ...
                                <div class="panel-body no-padding">
                                    <div class="table-responsive">
                                        <table id="table" class="table table-striped responsive" data-sortable="" data-sortable-initialized="true">
                                            ...
                                            <tbody>
                                            	<?php if(is_array($enterprise)): foreach($enterprise as $key=>$v): ?><tr>
	                                                    <td><img src="/xingkong/<?php echo ($v["face245"]); ?>"</td>
	                                                    <td><?php echo ($v["name"]); ?></td>
	                                                    <td><?php echo ($v["intro"]); ?></td>
	                                                    <td><?php echo ($v["url"]); ?></td>
	                                                    <td><?php echo ($v["sort"]); ?></td>
	                                                    <td>
	                                                    	<a href="<?php echo U('Enterprise/edit', ['id' => $v['id']]);?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="编辑"><span class="fa fa-edit text-success"></span></a>&nbsp;
                                             			  	<a class="del" href="<?php echo U('Enterprise/del', ['id' => $v['id']]);?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="删除"><span class="fa fa-trash-o text-success"></span></a>
	                                                    </td>
