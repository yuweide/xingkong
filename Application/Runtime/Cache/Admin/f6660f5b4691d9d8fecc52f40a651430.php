                      ...
                      <div class="panel-body">
                          <form class="form-horizontal bordered-group" role="form" action="<?php echo U('AdManage/editHandle');?>" method="post">
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-2">
                                  	<img id="no-image" <?php if($data['big_thumb']): ?>src="/xingkong/<?php echo ($data["big_thumb"]); ?>"<?php else: ?> src="/xingkong/Public/Default/images/no_image.jpg"<?php endif; ?> >
                                  </div>
                              ...
                              <?php if($pos == 1 || $pos == 2): ?><div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                      <img id="no-image-small" <?php if($data['small_thumb']): ?>src="/xingkong/<?php echo ($data["small_thumb"]); ?>"<?php else: ?> src="/xingkong/Public/Default/images/no_image.jpg"<?php endif; ?> >
                                    </div>
                                    <div class="col-sm-8" style="margin-top:20px;">
                              ...
                              <input type="hidden" name="big_thumb" value="<?php echo ($data["big_thumb"]); ?>">
                              <input type="hidden" name="small_thumb" value="<?php echo ($data["small_thumb"]); ?>">
		    ...
		    $('#upload').uploadify({
		      ...
		      onUploadSuccess :     function(file, data, response) {
		        ...
		        if (data.status == 1) {
		        	...
		        	$('#no-image').attr('src', "/xingkong/"+data.path.big_thumb);
		        } else {
		         	alert('图片上传失败，请重试...');
		        }
		      }
        ...
        $('#uploadSmallThumb').uploadify({
          ...
          onUploadSuccess :     function(file, data, response) {
            ...
            if (data.status == 1) {
              ...
              $('#no-image-small').attr('src', "/xingkong/"+data.path.small_thumb);
            } else {
              alert('图片上传失败，请重试...');
            }
          }
