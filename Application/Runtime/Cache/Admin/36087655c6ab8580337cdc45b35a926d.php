                ...
                <ul class="nav navbar-nav pull-left">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu filter" data-option-key="filter" role="menu">
                            ...
                            <?php if(is_array($cate)): foreach($cate as $key=>$v): ?><li><a href="javascript:;" data-filter=".filter-<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></a><?php endforeach; endif; ?>
                	...
                	<!-- content start -->
                	 <div class="switcher view-list">
                            <div class="row feed no-margin">
                            	<?php if(is_array($list)): foreach($list as $key=>$v): ?><div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 switch-item filter-<?php echo ($v["cate_id"]); ?>">
	                                    <section class="panel <?php if(!$v['face200']): ?>bg-warning<?php endif; ?>">
	                                    	<?php if($v['face200']): ?><div class="thumb">
		                                            <img class="img-responsive" alt="Responsive image" src="/xingkong/<?php echo ($v["face200"]); ?>">
		                                        </div><?php endif; ?>
	                                        <div class="panel-body">
	                                            <div class="switcher-content">
	                                                <p>
	                                                	<?php echo ($v["title"]); ?> &nbsp;&nbsp;&nbsp;<span class="text-default"><?php echo (date("Y-m-d", $v["create_time"])); ?></span>
	                                                </p>
	                                                <p><?php echo (mb_substr($v["desc"], 0, 60, 'UTF-8')); ?>...</p>
	                                                <p class="show small">编辑：<?php echo ($v["editor"]); ?></p>
	                                                <ul class="text-muted list-style-none" style="font-size:14px;">
	                                                	<a href="<?php echo U('News/edit', ['id' => $v['id']]);?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="编辑"><span class="fa fa-edit text-success"></span></a>
	                                                	<a class="del" href="<?php echo U('News/del', ['id' => $v['id']]);?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="删除"><span class="fa fa-trash-o text-success"></span></a>
	                                                </ul>
