                    	...
                    	<div class="col-lg-12">
                             ...
                             <section class="panel">
								    ...
								    <table class="table table-bordered table-hover no-margin">
								        ...
								        <tbody>
								        	<?php if(is_array($lists)): foreach($lists as $key=>$v): ?><tr>
								                    ...
								                    <td>
								                    	<a href="<?php echo U('City/edit', array('id' => $v['id']));?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="编辑"><i class="fa fa-edit"></i></a>
								                    	<a href="<?php echo U('City/nonUse', array('id' => $v['id']));?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="停用"><i class="fa fa-trash-o"></i></a>
								                    </td>
								...
								<div class="panel-footer">
					            	<a class="btn btn-color btn-sm" href="<?php echo U('City/add');?>"><i class="fa fa-plus"></i> 添加</a>
							    </div>
							</section>
	                    </div>
                    </div>
