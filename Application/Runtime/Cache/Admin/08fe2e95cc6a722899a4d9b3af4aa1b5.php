                	...
                	<div class="col-lg-12">
                 	<section class="panel">
                      ...
                      <div class="panel-body">
                          <form class="form-horizontal bordered-group" role="form" action="<?php echo U('Theater/editHandle');?>" method="post">
                              <div class="form-group">
                                  <label class="col-sm-2 control-label"><span class="red">* </span>城市</label>
                                  <div class="col-sm-8">
                                      <select class="form-control" name="city_id">
                                          <?php if(is_array($city)): foreach($city as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>" <?php if($v['id'] == $data['city_id']): ?>selected<?php endif; ?>><?php echo ($v["name"]); ?></option><?php endforeach; endif; ?>
                                      </select>
                                  </div>
                              </div>
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" name="name" value="<?php echo ($data["name"]); ?>" placeholder="影城名称" class="form-control" id="inputEmail3">
                                  </div>
                              </div>
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-3">
                                  	<img id="no-image"<?php if($data['face520']): ?>src="/xingkong/<?php echo ($data["face520"]); ?>"<?php else: ?>src="/xingkong/Public/Default/images/no_image.jpg"<?php endif; ?> >
                                  </div>
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" class="form-control" value="<?php echo ($data["address"]); ?>" name="address" id="inputEmail6" placeholder="地址">
                                  </div>
                              </div>
                              <div class="form-group">
                                  <label for="inputEmail5" class="col-sm-2 control-label">经度</label>
                                  <div class="col-sm-8">
                                      <input type="text" class="form-control" value="<?php echo ($data["x"]); ?>" name="x" id="inputEmail5" placeholder="用于地图定位">
                                  </div>
                              </div>
                              <div class="form-group">
                                  <label for="inputEmail5" class="col-sm-2 control-label">维度</label>
                                  <div class="col-sm-8">
                                      <input type="text" class="form-control" value="<?php echo ($data["y"]); ?>" name="y" id="inputEmail5" placeholder="用于地图定位">
                                  </div>
                              </div>
                              <div class="form-group">
                                  <label for="inputEmail5" class="col-sm-2 control-label">订票热线</label>
                                  <div class="col-sm-8">
                                      <input type="text" class="form-control" value="<?php echo ($data["order_line"]); ?>" name="order_line" id="inputEmail5" placeholder="订票热线">
                                  </div>
                              </div>
                               <div class="form-group">
                                  <label for="inputEmail5" class="col-sm-2 control-label">团购热线</label>
                                  <div class="col-sm-8">
                                      <input type="text" class="form-control" value="<?php echo ($data["group_line"]); ?>" name="group_line" id="inputEmail5" placeholder="团购热线">
                                  </div>
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-8">
                                      <textarea name="intro" class="form-control" rows="2"><?php echo ($data["intro"]); ?></textarea>
                                  </div>
                              </div> 
                              
                              <input type="hidden" name="face520" value="<?php echo ($data["face520"]); ?>">
                              <input type="hidden" name="face40" value="<?php echo ($data["face40"]); ?>">
	...
	setTimeout(function() {
		 var sid = "<?php echo session_id();?>";
		    $('#upload').uploadify({
		      ...
		      'uploader'      :    "<?php echo U('Base/uploadTheaterFace');?>",
		      ...
		      onUploadSuccess :     function(file, data, response) {
		        ...
		        if (data.status == 1) {
		        	...
		        	$('#no-image').attr('src', "/xingkong/"+data.path.face520);
		        } else {
		        	$('#info').html('上传失败，请重试');
		        }
		      }
