...
<div class="h35"></div>
    <div id="wvdm1">
        <div id="wvdm2">
        	<h3>影城分布</h3>
        	<?php if(is_array($city)): foreach($city as $key=>$v): if($v['theater']): ?><p><b><?php echo ($v["name"]); ?></b></p>
	          		<?php if(is_array($v['theater'])): foreach($v['theater'] as $key=>$val): ?><p><img src="/xingkong/Public/Home/images/about/1.jpg" width="5" height="6" /><a href="<?php echo U('Theater/detail', ['id' => $val['id']]);?>"><?php echo ($val["name"]); ?></a></p><?php endforeach; endif; endif; endforeach; endif; ?> 
        </div>
        <div id="wvdm3">
        <img src="/xingkong/Public/Home/images/about/2.jpg" width="635" height="524" /> </div>
    </div>
    <div class="clear"></div>
</div>
