...
<style>
	...
	.content .con-top .con-msg {
		border-bottom:1px solid #999;
		padding-bottom:10px;
	}
	.content .con-top .con-msg span {
		color:#666;
...
<div class="all">
	<div class="content">
		<div class="con-top">
			...
			<div class="con-msg">
				<span>编辑：<?php echo ($data["editor"]); ?></span><span>日期：<?php echo (date("Y-m-d", $data["create_time"])); ?></span><span>来源：<?php echo ($data["from"]); ?></span>
			</div>
		</div>
		<div class="con">
