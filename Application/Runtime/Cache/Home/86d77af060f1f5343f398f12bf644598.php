...
<div class="all">
  <div class="all_1"> 
    <?php if(is_array($cate)): foreach($cate as $key=>$v): ?><a href="<?php echo U('Movie/lists',['cid' => $v['id']]);?>"><?php echo ($v["name"]); ?></a><?php endforeach; endif; ?>
    <a class="zzsy" href="<?php echo U('Movie/enterprise');?>">合作企业</a>
  </div>
  <div class="all_5" style="overflow:hidden">
  	<?php if(is_array($enterprise)): foreach($enterprise as $key=>$v): ?><div class="all_51">
	    	<div class="all_51_1">
         <a href="<?php echo ($v["url"]); ?>" title="<?php echo ($v["name"]); ?>" target="_blank"><img src="/xingkong/<?php echo ($v["face245"]); ?>" width="245" height="115" /></a>
        </div>
	    <div class="all_51_2"></div>
