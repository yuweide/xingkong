...
<div class="all">
  ...
  <div class="all_5">
  	<?php if(is_array($list)): foreach($list as $key=>$v): ?><div class="all_51">
	    	<div class="all_51_1"><img src="/xingkong/<?php echo ($v["face209"]); ?>" width="209" height="114" /></div>
	    <div class="all_51_2"><a href="<?php echo U('Movie/play', ['id' => $v['id']]);?>"><?php echo (mb_substr($v["name"], 0, 15, 'UTF-8')); ?>...</a></div>
