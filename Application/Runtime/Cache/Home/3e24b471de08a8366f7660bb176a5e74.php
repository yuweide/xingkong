...
<div class="all">
  <div class="all_1">
  	<?php if(is_array($cate)): foreach($cate as $key=>$v): ?><a <?php if($cid == $v['id']): ?>class="zzsy"<?php endif; ?> href="<?php echo U('News/index', array('cid' => $v['id']));?>"><?php echo ($v["name"]); ?></a><?php endforeach; endif; ?>
	</div>  
  <div class="all_6">
  	<?php if(is_array($list)): foreach($list as $key=>$v): ?><div class="all_61">
	    	<div class="all_61_l"><img src="<?php if($v['face200']): ?>/xingkong/<?php echo ($v["face200"]); else: ?>/xingkong/Public/Default/images/no_image.jpg<?php endif; ?>" width="200" height="230" /></div>
	        	<div class="all_61_r">
		            <h1><a href="<?php echo U('News/detail', array('id' => $v['id']));?>"><?php echo ($v["title"]); ?></a></h1>
		            <p><span><?php echo (date("Y/m/d H:i", $v["create_time"])); ?></span></p>
		            <p><?php echo ($v["desc"]); ?></p>
	            </div>
	    	<div class="clear"></div>
	    </div><?php endforeach; endif; ?>
  </div> 
  <div class="page-style"><?php echo ($page); ?></div>
  <div class="clear"></div>
</div>
<!--脚部开始-->
<div class="foot">
